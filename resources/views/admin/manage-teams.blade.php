<x-app-layout>
    ...
    <main class="py-12 max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <x-panel>
            <div class="flex justify-between">
                ...
                <form method="GET" action="#" class="mb-6 w-1/2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{request('search')}}" class="block w-full px-6 py-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search Teams">
                ...
                <div class="flex items-center flex-shrink-0 end mb-4">
                    <h4 class="mr-6 font-bold">ADD TEAM</h4>
                    <a href="{{route('team.create')}}">
                        <i class="fas fa-solid fa-plus rounded-lg border-2 border-gray-300 p-3"  title="add team"></i>
                    </a>
                </div>
            </div>
            @if(\App\Models\Team::count())
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        @foreach(\App\Models\Team::latest()->filter(request(['search']))->orderBy('name')->get() as $key => $team)
            ...
            @else
                <div class="flex justify-center items-center"><p class="font-bold">No teams yet.</p> </div>
            @endif
        </x-panel>
    </main>
</x-app-layout>
