            ...
            <div class="flex justify-between">
                ...
                <form method="GET" action="#" class="mb-6 w-1/2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{request('search')}}" class="block w-full px-6 py-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search Users">
                ...
                <div class="flex items-center flex-shrink-0 end mb-4">
                    <h4 class="mr-6 font-bold">ADD USER</h4>
