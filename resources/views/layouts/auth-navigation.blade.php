        ...
        <div class="flex px-auto justify-between h-20">
            ...
            <div class="flex">
                ...
                @if(Auth::user()->role == User::ADMIN)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link title="Management" :href="route('admin_dashboard')" :active="request()->routeIs('admin_dashboard') ">
                            <x-nav-icon >
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <img src="{{ (!empty(Auth::user()->image)) ? asset(Auth::user()->image) : asset('avatars/avatar-'. auth()->id() .'.png')  }}" style="border-radius: 50%" width="40" alt="PF">
