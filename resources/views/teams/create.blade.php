...
<x-app-layout>
    ...
    <main class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6 py-12">
        <x-panel class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold mb-4">Create new team</h2>

            <div class="flex justify-center p-6">
                <img id="showImage" width="150" src="{{asset('card-logos/teamLogo.svg')}}" alt="Team Logo">
            </div>


            <form method="post" action="{{ route('team.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <x-form.text-input id="city" name="city" type="text" class="mt-1 block w-full" :value="old('city')" required autofocus autocomplete="city" />
                ...
                <div class="grid grid-cols-2 space-x-4">
                    ...
                    <div>
                        ...
                        <x-form.text-input id="stadium" name="stadium" type="text" class="mt-1 block w-full" :value="old('stadium')" required autofocus autocomplete="stadium" />
                        <x-form.input-error class="mt-2" :messages="$errors->get('stadium')" />
                    </div>

                    <div>
                        <x-form.input-label for="capacity" :value="__('Capacity')" />
                        <x-form.text-input id="capacity" name="capacity" type="number" class="mt-1 block w-full" :value="old('capacity')" required autofocus autocomplete="capacity" />
                ...
                <div class="grid grid-cols-2 space-x-4">
                    ...
                    <div>
                        ...
                        <x-form.text-input id="coach" name="coach" type="text" class="mt-1 block w-full" :value="old('coach')" required autofocus autocomplete="coach" />
                    ...
                    <div>
                        ...
                        <x-form.select-league id="league_id" name="league_id"  class="block"  :leagues="\App\Models\League::orderBy('name')->get()" :league="old('league_id')" autofocus autocomplete="league_id"/>
